...
namespace BigDrive.Provider.Archive
{
    ...
    /// <summary>
    /// Provides assembly resolution for NuGet package dependencies (SharpCompress and its dependencies).
    ...
    internal static class AssemblyResolver
    {
        ...
        private static Assembly ResolveAssembly(object sender, ResolveEventArgs args)
        {
            ...
            // List of assemblies we handle (SharpCompress and common dependencies)
