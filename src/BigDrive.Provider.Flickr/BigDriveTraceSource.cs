...
namespace BigDrive.Provider.Flickr
{
    ...
    /// <summary>
    /// Provides tracing capabilities for the Flickr provider.
    ...
    internal class BigDriveTraceSource : TraceSource
    {
        ...
        /// </summary>
        private const string SourceName = "BigDrive.Provider.Flickr";
        ...
        static BigDriveTraceSource()
        {
            ...
            Instance.Switch = new SourceSwitch("BigDriveFlickrSwitch", "All");
