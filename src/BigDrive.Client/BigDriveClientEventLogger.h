// <copyright file="BigDriveClientEventLogger.h" company="Wayne Walter Berry">
...
/// </summary>
class BigDriveClientEventLogger
{
private:
    /// <summary>
...
public:
    ...
    explicit BigDriveClientEventLogger(LPCWSTR eventSourceName);

    /// <summary>
    /// Destructor to clean up the event log handle.
    /// </summary>
    ~BigDriveClientEventLogger();
