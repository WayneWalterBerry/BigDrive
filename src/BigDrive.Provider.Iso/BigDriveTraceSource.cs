...
namespace BigDrive.Provider.Iso
{
    ...
    /// <summary>
    /// Provides tracing capabilities for the ISO provider.
    ...
    internal class BigDriveTraceSource : TraceSource
    {
        ...
        /// </summary>
        private const string SourceName = "BigDrive.Provider.Iso";
        ...
        static BigDriveTraceSource()
        {
            ...
            Instance.Switch = new SourceSwitch("BigDriveIsoSwitch", "All");
