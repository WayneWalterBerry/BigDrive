// <copyright file="BigDriveShellFolder-IExtractIconW.cpp" company="Wayne Walter Berry">
...
HRESULT __stdcall BigDriveShellFolder::GetIconLocation(
    ...
    UINT* pwFlags)
{
    // Example: Use the standard shell32.dll icons for folders and files
    // In a real implementation, you may want to provide custom icons per item type
    ...
    HRESULT hr = ::StringCchCopyW(pszFile, cchMax, L"shell32.dll");
    if (FAILED(hr))
    {
        return hr;
    }
    ...
    // You may want to inspect the PIDL to determine the type
    // For now, always return the folder icon
