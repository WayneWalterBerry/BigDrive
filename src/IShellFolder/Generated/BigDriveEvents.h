...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "BigDrive" event count 4
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = b7a1a2c3-4d5e-6f70-8191-92a3b4c5d6e7
EXTERN_C __declspec(selectany) const GUID BIGDRIVE_PROVIDER = {0xb7a1a2c3, 0x4d5e, 0x6f70, {0x81, 0x91, 0x92, 0xa3, 0xb4, 0xc5, 0xd6, 0xe7}};

#ifndef BIGDRIVE_PROVIDER_Traits
#define BIGDRIVE_PROVIDER_Traits NULL
#endif // BIGDRIVE_PROVIDER_Traits

//
// Channel
//
#define BIGDRIVE_PROVIDER_CHANNEL_ADMIN 0x10
#define BIGDRIVE_PROVIDER_CHANNEL_ADMIN_KEYWORD 0x8000000000000000
#define BIGDRIVE_PROVIDER_CHANNEL_ANALYTIC 0x11
#define BIGDRIVE_PROVIDER_CHANNEL_ANALYTIC_KEYWORD 0x4000000000000000

//
// Tasks
//
#define BIGDRIVE_PROVIDER_TASK_General 0x1

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR BIGDRIVE_EVENT_INFO = {0x1, 0x0, 0x10, 0x4, 0x0, 0x1, 0x8000000000000000};
#define BIGDRIVE_EVENT_INFO_value 0x1
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR BIGDRIVE_EVENT_ERROR = {0x2, 0x0, 0x10, 0x2, 0x0, 0x1, 0x8000000000000000};
#define BIGDRIVE_EVENT_ERROR_value 0x2
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR BIGDRIVE_EVENT_ENTER = {0x3, 0x0, 0x11, 0x5, 0x1, 0x1, 0x4000000000000000};
#define BIGDRIVE_EVENT_ENTER_value 0x3
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR BIGDRIVE_EVENT_LEAVE = {0x4, 0x0, 0x11, 0x5, 0x2, 0x1, 0x4000000000000000};
#define BIGDRIVE_EVENT_LEAVE_value 0x4
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG BigDriveEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG BigDriveKeywords[3] = {0x8000000000000000, 0x8000000000000000, 0x4000000000000000};
EXTERN_C __declspec(selectany) const unsigned char BigDriveLevels[3] = {4, 2, 5};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT BIGDRIVE_PROVIDER_Context = {0, (ULONG_PTR)BIGDRIVE_PROVIDER_Traits, 0, 0, 0, 0, 0, 0, 3, BigDriveEnableBits, BigDriveKeywords, BigDriveLevels};

//
// Provider REGHANDLE
//
#define BigDriveHandle (BIGDRIVE_PROVIDER_Context.RegistrationHandle)
...
//
#define BIGDRIVE_PROVIDER_EventWriteActivity 0
...
//
#ifndef EventRegisterBigDrive
#define EventRegisterBigDrive() McGenEventRegister(&BIGDRIVE_PROVIDER, McGenControlCallbackV2, &BIGDRIVE_PROVIDER_Context, &BigDriveHandle)
#endif
...
//
#ifndef EventRegisterByGuidBigDrive
#define EventRegisterByGuidBigDrive(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &BIGDRIVE_PROVIDER_Context, &BigDriveHandle)
#endif
...
//
#ifndef EventUnregisterBigDrive
#define EventUnregisterBigDrive() McGenEventUnregister(&BigDriveHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_BigDrive));
// - Caller registers the provider, e.g. EventRegisterBigDrive_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterBigDrive_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_BigDrive {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use BigDriveHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_BigDrive;

#define EventRegisterBigDrive_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_BigDrive_, MCGEN_EVENTREGISTER)(&BIGDRIVE_PROVIDER, pContext)
#define EventRegisterByGuidBigDrive_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_BigDrive_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterBigDrive_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define BigDriveHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_BigDrive_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_BigDrive* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)BIGDRIVE_PROVIDER_Traits;
    pContext->Context.EnableBitsCount = 3;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = BigDriveKeywords;
    pContext->Context.EnableLevel = BigDriveLevels;
...
FORCEINLINE
_Ret_ McGenContext_BigDrive*
_mcgen_CheckContextType_BigDrive(_In_ McGenContext_BigDrive* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "BIGDRIVE_EVENT_INFO"
//
#define EventEnabledBIGDRIVE_EVENT_INFO() _mcgen_EVENT_BIT_SET(BigDriveEnableBits, 0)
#define EventEnabledBIGDRIVE_EVENT_INFO_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_BigDrive(pContext)->EnableBits, 0)

//
// Event write macros for event "BIGDRIVE_EVENT_INFO"
//
#define EventWriteBIGDRIVE_EVENT_INFO(Message) \
        MCGEN_EVENT_ENABLED(BIGDRIVE_EVENT_INFO) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_INFO(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_INFO, Message) : 0
#define EventWriteBIGDRIVE_EVENT_INFO_AssumeEnabled(Message) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_INFO(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_INFO, Message)
#define EventWriteBIGDRIVE_EVENT_INFO_ForContext(pContext, Message) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, BIGDRIVE_EVENT_INFO) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_INFO(&(pContext)->Context, &BIGDRIVE_EVENT_INFO, Message) : 0
#define EventWriteBIGDRIVE_EVENT_INFO_ForContextAssumeEnabled(pContext, Message) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_INFO(&_mcgen_CheckContextType_BigDrive(pContext)->Context, &BIGDRIVE_EVENT_INFO, Message)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_INFO _mcgen_PASTE2(McTemplateU0z_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "BIGDRIVE_EVENT_ERROR"
//
#define EventEnabledBIGDRIVE_EVENT_ERROR() _mcgen_EVENT_BIT_SET(BigDriveEnableBits, 1)
#define EventEnabledBIGDRIVE_EVENT_ERROR_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_BigDrive(pContext)->EnableBits, 1)

//
// Event write macros for event "BIGDRIVE_EVENT_ERROR"
//
#define EventWriteBIGDRIVE_EVENT_ERROR(Message) \
        MCGEN_EVENT_ENABLED(BIGDRIVE_EVENT_ERROR) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ERROR(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_ERROR, Message) : 0
#define EventWriteBIGDRIVE_EVENT_ERROR_AssumeEnabled(Message) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ERROR(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_ERROR, Message)
#define EventWriteBIGDRIVE_EVENT_ERROR_ForContext(pContext, Message) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, BIGDRIVE_EVENT_ERROR) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ERROR(&(pContext)->Context, &BIGDRIVE_EVENT_ERROR, Message) : 0
#define EventWriteBIGDRIVE_EVENT_ERROR_ForContextAssumeEnabled(pContext, Message) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ERROR(&_mcgen_CheckContextType_BigDrive(pContext)->Context, &BIGDRIVE_EVENT_ERROR, Message)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ERROR _mcgen_PASTE2(McTemplateU0z_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "BIGDRIVE_EVENT_ENTER"
//
#define EventEnabledBIGDRIVE_EVENT_ENTER() _mcgen_EVENT_BIT_SET(BigDriveEnableBits, 2)
#define EventEnabledBIGDRIVE_EVENT_ENTER_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_BigDrive(pContext)->EnableBits, 2)

//
// Event write macros for event "BIGDRIVE_EVENT_ENTER"
//
#define EventWriteBIGDRIVE_EVENT_ENTER(Function, Line) \
        MCGEN_EVENT_ENABLED(BIGDRIVE_EVENT_ENTER) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ENTER(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_ENTER, Function, Line) : 0
#define EventWriteBIGDRIVE_EVENT_ENTER_AssumeEnabled(Function, Line) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ENTER(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_ENTER, Function, Line)
#define EventWriteBIGDRIVE_EVENT_ENTER_ForContext(pContext, Function, Line) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, BIGDRIVE_EVENT_ENTER) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ENTER(&(pContext)->Context, &BIGDRIVE_EVENT_ENTER, Function, Line) : 0
#define EventWriteBIGDRIVE_EVENT_ENTER_ForContextAssumeEnabled(pContext, Function, Line) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ENTER(&_mcgen_CheckContextType_BigDrive(pContext)->Context, &BIGDRIVE_EVENT_ENTER, Function, Line)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_ENTER _mcgen_PASTE2(McTemplateU0sq_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "BIGDRIVE_EVENT_LEAVE"
//
#define EventEnabledBIGDRIVE_EVENT_LEAVE() _mcgen_EVENT_BIT_SET(BigDriveEnableBits, 2)
#define EventEnabledBIGDRIVE_EVENT_LEAVE_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_BigDrive(pContext)->EnableBits, 2)

//
// Event write macros for event "BIGDRIVE_EVENT_LEAVE"
//
#define EventWriteBIGDRIVE_EVENT_LEAVE(Function, Line, Result) \
        MCGEN_EVENT_ENABLED(BIGDRIVE_EVENT_LEAVE) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_LEAVE(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_LEAVE, Function, Line, Result) : 0
#define EventWriteBIGDRIVE_EVENT_LEAVE_AssumeEnabled(Function, Line, Result) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_LEAVE(&BIGDRIVE_PROVIDER_Context, &BIGDRIVE_EVENT_LEAVE, Function, Line, Result)
#define EventWriteBIGDRIVE_EVENT_LEAVE_ForContext(pContext, Function, Line, Result) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, BIGDRIVE_EVENT_LEAVE) \
        ? _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_LEAVE(&(pContext)->Context, &BIGDRIVE_EVENT_LEAVE, Function, Line, Result) : 0
#define EventWriteBIGDRIVE_EVENT_LEAVE_ForContextAssumeEnabled(pContext, Function, Line, Result) \
        _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_LEAVE(&_mcgen_CheckContextType_BigDrive(pContext)->Context, &BIGDRIVE_EVENT_LEAVE, Function, Line, Result)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_BIGDRIVE_EVENT_LEAVE _mcgen_PASTE2(McTemplateU0sqd_, MCGEN_EVENTWRITETRANSFER)
...
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateU0sq_def
#define McTemplateU0sq_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0sq_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
...
{
#define McTemplateU0sq_ARGCOUNT 2

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0sq_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0sq_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0sq_def

//
// Function for template "T3" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateU0sqd_def
#define McTemplateU0sqd_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0sqd_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
    _In_opt_ PCSTR  _Arg0,
    _In_ const unsigned int  _Arg1,
...
{
#define McTemplateU0sqd_ARGCOUNT 3

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0sqd_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0sqd_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0sqd_def

//
// Function for template "T1" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
...
#define MSG_BIGDRIVE_EVENT_INFO_MSG          0xB0000001L
#define MSG_BIGDRIVE_EVENT_ERROR_MSG         0xB0000002L
#define MSG_BIGDRIVE_EVENT_ENTER_MSG         0xB0000003L
#define MSG_BIGDRIVE_EVENT_LEAVE_MSG         0xB0000004L
