...
private:
	...
	BigDriveShellIcon(BigDriveShellFolder* pParentFolder, UINT cidl, PCUITEMID_CHILD_ARRAY apidl);
...
public:
	...
	static HRESULT CreateInstance(BigDriveShellFolder* pFolder, UINT cidl, PCUITEMID_CHILD_ARRAY apidl, REFIID riid, void** ppv);
