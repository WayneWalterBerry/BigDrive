// <copyright file="ItemIdDictionaryTests.cpp" company="Wayne Walter Berry">
...
#include "..\..\..\src\IShellFolder\Exports\ItemIdDictionaryImports.h"
...
namespace BigDriveShellFolderTest
{
    ...
    TEST_CLASS(ItemIdDictionaryTests)
    {
    public:

        TEST_METHOD(Serialize_EmptyList_ReturnsEmptyString)
        {
            LPITEMIDLIST pidl = (LPITEMIDLIST)CoTaskMemAlloc(sizeof(USHORT));
            *(USHORT*)pidl = 0;
            BSTR result = nullptr;

            HRESULT hr = ItemIdDictionary_Serialize(pidl, &result);
        ...
        TEST_METHOD(Serialize_SingleItem)
        {
            BYTE abid1[] = { 'A', 'B' };
        ...
        TEST_METHOD(Serialize_MultipleItems)
        {
            BYTE abid1[] = { 'X' };
            BYTE abid2[] = { 'Y', 'Z' };
        ...
        TEST_METHOD(Serialize_ZeroLengthabID)
        {
            BYTE abid1[] = { 0 };
            const BYTE* abids[] = { abid1 };
            size_t abidLens[] = { 0 };
        ...
        TEST_METHOD(Deserialize_EmptyString_ReturnsTerminator)
        {
            LPITEMIDLIST pidl = nullptr;
            BSTR bstr = ::SysAllocString(L"");

            HRESULT hr = ItemIdDictionary_Deserialize(bstr, &pidl);
        ...
        TEST_METHOD(Deserialize_SingleItem)
        {
            LPITEMIDLIST pidl = nullptr;
        ...
        TEST_METHOD(Deserialize_MultipleItems)
        {
            LPITEMIDLIST pidl = nullptr;
        ...
        TEST_METHOD(Deserialize_NullPointer_ReturnsPointerError)
        {
            BSTR bstr = ::SysAllocString(L"AB");
            HRESULT hr = ItemIdDictionary_Deserialize(bstr, nullptr);
        ...
        TEST_METHOD(SerializeThenDeserialize_RoundTrip_SingleItem)
        {
            ...
            HRESULT hr1 = ItemIdDictionary_Serialize(pidl, &serialized);
            HRESULT hr2 = ItemIdDictionary_Deserialize(serialized, &roundTrip);
        ...
        TEST_METHOD(Deserialize_MoreThan16Items_HeapAllocFallback)
        {
        ...
        TEST_METHOD(Serialize_MyPC_Pidl_ReturnsMyPC)
        {
            // Get the "My PC" (Drives) PIDL using SHGetSpecialFolderLocation with CSIDL_DRIVES
            LPITEMIDLIST pidl = nullptr;
            HRESULT hrInit = ::SHGetSpecialFolderLocation(nullptr, CSIDL_DRIVES, &pidl);
            Assert::AreEqual(S_OK, hrInit);
            Assert::IsTrue(pidl != nullptr);
            ...
            // The implementation returns "My PC" for the drives PIDL
            Assert::AreEqual(0, wcscmp(result, L"My PC"));
