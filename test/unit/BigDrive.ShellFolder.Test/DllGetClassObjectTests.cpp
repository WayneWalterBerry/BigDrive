...
namespace BigDriveShellFolderTest
{
    ...
    /// </summary>
    TEST_CLASS(DllGetClassObjectTests)
    {
    private:
    ...
    public:
        ...
        TEST_METHOD(TestValidCLSID)
        {
            ...
            // Act
            HRESULT hr = DllGetClassObjectExport(validCLSID, requestedIID, reinterpret_cast<void**>(&pClassFactory));
        ...
        TEST_METHOD(TestInvalidCLSID)
        {
            ...
            // Act
            HRESULT hr = DllGetClassObjectExport(invalidCLSID, requestedIID, reinterpret_cast<void**>(&pClassFactory));
        ...
        TEST_METHOD(TestNullPPV)
        {
            ...
            // Act
            HRESULT hr = DllGetClassObjectExport(validCLSID, requestedIID, nullptr);
        ...
        TEST_METHOD(TestUnsupportedIID)
        {
            ...
            // Act
            HRESULT hr = DllGetClassObjectExport(validCLSID, unsupportedIID, &pUnknown);
